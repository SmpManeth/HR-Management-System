    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto lg:py-16">
            <form action="{{ route('users.store') }}" method="post">
                @csrf
                <h2 class="mb-4 text-xl font-semibold leading-none text-gray-900 dark:text-white">Add User</h2>
                ...
                <button type="submit" class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">Add User</button>
