                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">{{ $attendance->employee ? $attendance->employee->Employee_ID : '' }}</td>
                                <td class="px-4 py-3">{{ $attendance->employee ? $attendance->employee->Stage_name : '' }}</td>
                                <td class="px-4 py-3">{{ $attendance->check_in }}</td>
                                <td class="px-4 py-3">{{ $attendance->check_out }}</td>
                                <td class="px-4 py-3">{{ $attendance->shift }}</td>
                                <td class="px-4 py-3">
                                    <?php
